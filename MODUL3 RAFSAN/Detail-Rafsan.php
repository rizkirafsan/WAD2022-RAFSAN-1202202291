...
<body>
  ...
  <main>
    <div class="container mt-4">
      ...
      <div class="title">
        <h3 class="fw-bold"><?= $data['nama_mobil'] ?></h3>
        <p class="text-secondary">Detail Data Mobil <?= $data['nama_mobil'] ?></p>
      </div>

      <div class="row mt-5">
        <div class="col-md-6">
          <img src="AMG.jpeg" alt="detail-image" class="img-fluid">
        </div>
        ...
        <div class="col-md-6">
          <form action="" method="POST">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="carName" name="carName" value="Mercedes-AMG"
                readonly>
            </div>
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="ownerName" name="ownerName"
                value="Rafsan-1202202291" readonly>
            </div>

            <div class="mb-3">
              <label for="brand" class="form-label fw-bold">Merk</label>
              <input type="text" class="form-control" id="brand" name="brand" value="Mercedes-Benz">
            </div>

            <div class="mb-3">
              <label for="buyDate" class="form-label fw-bold">Tanggal Beli</label>
              <input type="date" class="form-control" id="buyDate" name="buyDate" value="0/0/0000"
                readonly>
            </div>

            <div class="mb-3">
              <label for="description" class="form-label fw-bold">Deskripsi</label>
              <textarea class="form-control" id="description" name="description" value="ini deskripsi mobilnya"
                style="height: 100px" readonly></textarea>
            </div>

            <div class="mb-3">
              <label for="photo" class="form-label fw-bold">Foto</label>
              <input type="text" class="form-control" id="photo" value="ini foto mobilnya" readonly>
            </div>
            <div>
              ...
              <div class="mb-3 d-flex gap-4" id="choice">
                <div class="form-check">
                  ...
                  <input class="form-check-input" type="radio" id="lunas" name="status" value="lunas"
                    <?php echo ($data['status_pembayaran'] == "lunas") ? "checked" : ""; ?> disabled>
                ...
                <div class="form-check">
                  <input class="form-check-input" type="radio" id="notLunas" name="status" value="notLunas"
                    <?php echo ($data['status_pembayaran'] == "notLunas") ? "checked" : ""; ?> disabled>
                  <label class="form-check-label" for="notLunas">Belum Lunas</label><br>
                </div>
              </div>

            <a href="Edit-Rafsan.php?id=<?= $data['id'] ?>" class="btn btn-primary my-5 px-5" name="submit"
              id="submit">Edit</a>
          </form>
        </div>
      </div>
